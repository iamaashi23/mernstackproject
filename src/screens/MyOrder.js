...
export default function MyOrder() {
    ...
    return (
        <div style={{ backgroundColor:'black' }}>
            ...
            <div className='container' style={{ backgroundColor:'black' ,color:'white', margin:'auto' ,zIndex:'19'}}>
                                                ...
                                                <div  >
                                                    {arrayData.Order_date ? <div className='m-auto mt-5'>
                                                        ...
                                                        <div className='col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" ,backgroundColor:'black' , color:'white' ,borderColor:'white'}}>
